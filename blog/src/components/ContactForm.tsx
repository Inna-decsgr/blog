...
export default function ContactForm() {
  ...
  const onSubmit = (e:FormEvent<HTMLFormElement>) => {
    ...
    .then(() => {
      setBanner({message: '메일을 성공적으로 전송했습니다', state: 'success'})
  ...
  return (
    <section className='w-full max-w-md'>
      ...
      <form onSubmit={onSubmit} className='w-full flex flex-col gap-2 my-4 p-4 bg-slate-600 rounded-xl text-white'>
